...
DelphiUIAutomation is a framework for automating rich client applications based on Win32, written in Delphi and it requires no use of scripting languages.
